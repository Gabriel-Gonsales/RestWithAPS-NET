    ...
    public class TokenService : ITokenService
    {
        ...
        public string GenerateAccessToken(IEnumerable<Claim> claims)
        {
            ...
            var tokenOptions = new JwtSecurityToken(
                issuer: _configuration.Issuer, audience: _configuration.Audience, claims: claims, expires: DateTime.Now.AddMinutes(_configuration.Minutes),signingCredentials: signinCredentials);
